AirCon Control for Windows
==========================

1. Keep this folder together and double-click AirConControl.exe.
2. Open the gear button and enter the same account used to pair the AC.
...
Community ZIP builds are not code-signed. Windows SmartScreen may therefore
show an Unknown publisher warning. Public distributors should sign the
executable with their own Authenticode certificate before publishing it.
